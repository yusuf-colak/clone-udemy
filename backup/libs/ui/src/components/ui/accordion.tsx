...
type AccordionTriggerProps = {
  ...
  navbarToggle: boolean; // Adjust the type as needed
...
>(
  (
    { className, children, locked, navbarToggle, iconOnOnOff, ...props },
    ref
  ) => {
      ...
      <AccordionPrimitive.Header className="flex">
        ...
        >
          ...
          <div className="flex flex-row items-center">
            <div
              className={cn(
                !navbarToggle ? 'opacity-0 hidden' : 'delay-200 opacity-100',
                'pr-2 text-red-300'
              )}
            >
