...
import { DesktopTeacherMode, TeacherMode } from './teacherMode';
...
export default function SidebarDesktop({ guestRoutes, teacherRoutes }) {
  ...
  return (
    <motion.div
      animate={controls}
      className="max-w-[250px] px-4 animate duration-300
           relative group"
    >
      <div className="min-h-screen flex flex-col justify-between py-8 ">
        <div
          ...
          className={cn(
            'absolute justify-center items-center bg-black rounded-md w-6 h-6 cursor-pointer -right-3 top-11',
