...
async function main() {
  ...
  await assignPermissionsToRole('User', superadminRoleId);
  await assignPermissionsToRole('Role', superadminRoleId);
  await assignPermissionsToRole('Permission', superadminRoleId);
  await assignPermissionsToRole('Tenant', superadminRoleId);
  await assignPermissionsToRole('Domain', superadminRoleId);
